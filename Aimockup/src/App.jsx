  ...
  const [chats, setChats] = useLocalStorage("ui.chats", [
    {
      ...
      title: "ChatBox Ai",
      messages: [
        { id: uid(), role: "assistant", content: "Hi! I'm your helpful assistant. Ask me anything." },
      ],
    },
  ]);

  const [activeId, setActiveId] = useLocalStorage("ui.activeId", chats[0]?.id || "0");
...
/>
        ...
        <button
          ...
          className="absolute top-2 -translate-x-1/2 ml-10 z-50 md:hidden 
