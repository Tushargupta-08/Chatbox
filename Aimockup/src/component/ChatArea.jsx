...
const handleSend = async () => {
  ...
  return (
    <div className="flex flex-col h-full min-h-screen bg-white dark:bg-zinc-900">
      {/* Header */}
      <div className="bg-gradient-to-r from-emerald-400 to-green-200 dark:from-emerald-600 dark:to-green-400 p-3 shadow flex justify-center">
        <h2 className="font-semibold text-lg text-white">ChatBox</h2>
      </div>
